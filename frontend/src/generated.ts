...
export const guessTheHumanAbi = [
  {
    type: 'function',
    inputs: [
      { name: 'rows', internalType: 'uint256', type: 'uint256' },
      { name: 'columns', internalType: 'uint256', type: 'uint256' },
      { name: 'map', internalType: 'uint8[][]', type: 'uint8[][]' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'played', internalType: 'bool', type: 'bool' },
